...
\begin{resumo}[Resumo]
  Os Gêmeos Digitais (GDs) se tornaram um componente fundamental para a indústria 4.0, entranto a utilização atual de GDs em 
  ambientes de manufatura industrial não abrange a coordenação e gerenciamento de múltiplas instâncias simultâneas em um chão 
  ...
  ciclo de vida de múltiplas instâncias de Gêmeos Digitais no ambiente de chão de fábrica industrial. Essa arquiteturaintroduz uma 
  ...
  Os dados coletados dos ativosfísicos são tratados por uma caamda de ingestão dedicada que combina um agente de mensagens, um registro 
  de esquemas e um roteador de eventos, e uma possível modelagem ontológica baseada em grafos de conhecimento. A interoperabilidade
