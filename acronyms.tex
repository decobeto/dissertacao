...
\xnewacronym{AI}{Artificial Intelligence}
...
\xnewacronym{DTConnector}{Digital Twin Connector}
...
\xnewacronym{ML}{Machine Learning}
...
\xnewacronym[REST][long={RESTful}, short={REST}, sort={REST}]{REST}{REpresentational State Transfer}
